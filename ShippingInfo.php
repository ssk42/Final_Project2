	...
	<div class="body_div">
		<div class="innerdiv">
			...
			<h2>Shipping Info</h2>
				<p>MyOnlineGroceryStore is proud to offer FREE standard shipping 
				with your order of $25 or more (excluding taxes) to all U.S. destinations except Alaska and Hawaii.
				Free Shipping with your order of $25 or more on thousands of items Every Day! No codes. No end dates.
				Larger orders are usually shipped by FedEx Home Delivery or FedEx Ground (for business addresses). Smaller orders may be sent by USPS Priority Mail.
